namespace DropoutCoder.SmartGuideTdd.FindMultiples.Abstraction
{
    /// <summary>
    ...
    public interface IDivisibleValueFinder
    {
        ...
        /// <returns>A range of <see cref="uint"/> numbers divisible by <paramref name="base"/>, but not greater than <paramref name="limit"/></returns>
