...
using DropoutCoder.DuplicityFinder.Validation;

namespace DropoutCoder.DuplicityFinder
{
    class Program
    {
        ...
        ItemCountInput:
            ...
            var itemCountValidator = new RangeValidator(uint.MinValue + 2, uint.MaxValue);
        ...
        FinderIndexInput:
            ...
            if (!uint.TryParse(indexInput, out uint index) || !finderIndexValidator.IsValid(index))
            {
